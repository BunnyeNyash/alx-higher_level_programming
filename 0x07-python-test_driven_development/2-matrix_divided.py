...
def matrix_divided(matrix, div):
    ...
    # Check if the matrix is a valid matrix (list of lists) of integers/floats
    ...
    # Perform division on each element of the matrix and round the result to 2 decimal places
